...
const chunengShortcuts: Record<string, string> = {
  ...
  'cn-section-title':
    'relative pl-12px cn-text-md before:(content-empty absolute left-0 top-2px bottom-2px w-3px rd-2px bg-cn-blue-100)',
  ...
  'cn-status-dot-running': 'cn-status-dot bg-cn-success shadow-[0_0_0_2px_rgba(44,207,220,0.35)]',
  ...
  'cn-btn-warning': 'cn-btn !bg-cn-warning !border !border-cn-warning !text-white hover:!opacity-90 active:!opacity-80',
  'cn-btn-text': 'cn-btn !text-cn-blue-100 hover:!bg-cn-hover',

  // ---------- 标签 Tag ----------
  'cn-tag': 'font-600 tracking-wide cn-text-sm',
  'cn-tag-running': 'cn-tag !bg-cn-success/12 !border !border-cn-success/35 !text-cn-success',
  ...
  'cn-tag-maintenance': 'cn-tag !bg-cn-info/10 !border !border-cn-info/30 !text-cn-info',
  'cn-tag-energy': 'cn-tag !bg-cn-green-100/12 !border !border-cn-green-100/35 !text-cn-green-aux',

  // ---------- 卡片 Card ----------
  'cn-card':
    'border border-cn-border shadow-[0_1px_4px_rgba(0,40,170,0.06)] transition-shadow duration-200 hover:shadow-[0_2px_8px_rgba(0,40,170,0.08)]',
  'cn-card-highlight':
